...
import br.udesc.desbravadores.adapter.PontosListAdapter;
import br.udesc.desbravadores.adapter.PontosTuristicosAdapter;
...
public class PontosTuristicosAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.listViewPonto);
